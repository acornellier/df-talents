...
export class Controller extends React.PureComponent<Props> {
  ...
  componentDidMount() {
    this.setState({ tooltipRoot: document.getElementById('tooltip-root') })
  }

  componentDidUpdate() {
    if (this.state.isVisible) {
      const { width, height } = (
        ReactDOM.findDOMNode(this.tooltip.current) as HTMLElement
      ).getBoundingClientRect()
  ...
  getPosition = (
    tooltipDimensions = this.state.tooltipDimensions
